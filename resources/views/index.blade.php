...
<div class="container">
    ...
    <div class="carousel-inner">
        ...
        <img src="{{asset('emprego.png')}}" class="d-block w-100">
        </div>
        <div class="carousel-item">
        <img src="{{asset('lago.png')}}" class="d-block w-100">
        </div>
        <div class="carousel-item">
        <img src="{{asset('festival.png')}}" class="d-block w-100">
        </div>
    </div>
...
<div class="container">
  ...
  <div class="container">
    <div class="row">
    <div class="col-6"><img src="{{asset('policia.png')}}" class="img-fluid"> 
  ...
  <div class="col-6"> 
    ...
    <div class="card" style="width: 18rem;">
        <img src="{{ asset('tooronagashi.png')}}" class="card-img-top">
        <div class="card-body">
...
antepassados
    ...
    <div class="card" style="width: 18rem;">
        <img src="{{ asset('missakimatsuri.png')}}" class="card-img-top">
        <div class="card-body">
...
Miss Nikkey (nível nacional).</p>
    ...
    <div class="card" style="width: 18rem;">
        <img src="{{ asset('dezenasdeatracoes.png')}}" class="card-img-top">
        <div class="card-body">
...
os taikôs (tambores japoneses).</p>
    ...
    <div class="card" style="width: 18rem;">
    <video src="{{ asset('taiko.mp4')}}" class="object-fit-cover" controls></video>
        <div class="card-body">
    ...
    <div class="card" style="width: 18rem;">
        <video src="{{ asset('kpop.mp4')}}" class="object-fit-cover" controls></video>
        <div class="card-body">
    ...
    <div class="card" style="width: 18rem;">
        <video src="{{ asset('kodomo.mp4')}}" class="object-fit-cover" controls></video>
        <div class="card-body">
